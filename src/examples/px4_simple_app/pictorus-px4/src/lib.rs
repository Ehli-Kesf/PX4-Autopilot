...
//! ## Core Components
//!
//! ### FFI Protocol ([`uorb_binding`])
//!
//! The [`UorbBinding`](uorb_binding::UorbBinding) manages bidirectional message passing:
...
//! ### Pictorus Blocks
//!
//! - **[`UorbInputBlock<T>`](uorb_binding::UorbInputBlock)**: Reads uORB messages into Pictorus computation graphs
//! - **[`UorbOutputBlock<T>`](uorb_binding::UorbOutputBlock)**: Writes Pictorus results back to uORB system
//!
//! ## Usage Example
//!
//! ```rust
//! use pictorus_px4::uorb_binding::{UorbBinding, UorbInputBlock, UorbOutputBlock};
...
//! let output_block = UorbOutputBlock::<VehicleAttitudeSetpoint>::default();
//! ```
//!
